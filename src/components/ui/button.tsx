  ...
  "inline-flex items-center justify-center sm:gap-2 whitespace-nowrap rounded-md font-medium ring-offset-white transition-colors duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-gray-50/20 text-white hover:bg-white/30",
        dark:
          "bg-slate-950 text-white hover:bg-slate-950/90 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
        destructive:
          "bg-red-500 text-slate-50 hover:bg-red-500/90 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
        outline:
          "border border-blue-600 bg-white text-dark hover:bg-slate-100 hover:text-primary",
        ghost: "border border-white bg-white text-slate-950 hover:text-blue-600",
